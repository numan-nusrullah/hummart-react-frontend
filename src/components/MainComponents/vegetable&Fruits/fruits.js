...
import './css/fruitsAndVeg.css';
import Footer from '../../../Footer/footer';
import FruitAndVegiPic from '../../../pictures/vegetables& Fruits.jpg';
import {addUser} from '../../../actions/users';
import searchProducts from '../../../selectors/searchFilter';
import {URL} from '../../../URL';
class FruitsAndVegetable extends Component {
    constructor(props) {
        super(props);
        this.state = { 
            array:[]
    ...
    render() { 
        ...
        product.map((p)=>{
             if(p.category === 'Fruits & Vegetables'){
                    array.push(p);
             }
            }) 
        ...
        <div className='container fruitsAndVegetables'>
        <div className='row'>
         <div className='col heading'>
         <img className='frutAndVegiPic' src={FruitAndVegiPic} alt="3D Image"/>
         <span className='span'><i class="fas fa-home"></i>     <i class="fas fa-angle-right"></i> Fruits And Vegetables  </span>
        ...
        <div className='row'>  
        {
         ...
         <h5 className='proName'>{data.name}</h5> 
...
export default connect(mapStateToProps)(FruitsAndVegetable);