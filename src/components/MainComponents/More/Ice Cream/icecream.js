...
class IceCream extends Component {
    ...
    render() { 
        ...
        <h3 className='topHeading'>Ice Cream</h3>
        <span className='span'><i class="fas fa-home"></i>     <i class="fas fa-angle-right"></i> Ice Cream </span>

        <div className='row'>  
        {
            array.map((data)=>
            <div className='col-6 col-md-3 allProducts mt-3'>
            <Link className='nk' to={`/productDetails/${data._id}`}>
...
export default connect(mapStateToProps)(IceCream);