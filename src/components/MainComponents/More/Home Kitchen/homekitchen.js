...
class HomeKitchen extends Component {
    ...
    render() { 
        ...
        <h3 className='topHeading'>Home And Kitchen</h3> 
        <span className='span'><i class="fas fa-home"></i>     <i class="fas fa-angle-right"></i>  Home And Kitchen </span>
...
export default connect(mapStateToProps)(HomeKitchen);