...
class BabyKids extends Component {
    ...
    render() { 
        ...
        <h3 className='topHeading'>Baby And Kids</h3> 
        <span className='span'><i class="fas fa-home"></i>     <i class="fas fa-angle-right"></i>  Baby And Kids  </span>
...
export default connect(mapStateToProps)(BabyKids);