...
class Breakfast extends Component {
    ...
    render() { 
        ...
        <h3 className='topHeading'>House Hold Needs</h3> 
        <span className='span'><i class="fas fa-home"></i>     <i class="fas fa-angle-right"></i>  House Hold Needs  </span>
