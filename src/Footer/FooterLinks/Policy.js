        ...
        <div className='container'>
         <div className='row'>
          <div className='col mt-5'>
            ...
            <p>
            At HumMart, we understand your concern about your personal information, we care about it too. As such, we ensure we safeguard the information provided and honor your requests for confidentiality when you log in to www. Hummart.com Website and mobile app.

1.1 This private policy governs your privacy rights regarding our collection, storage and accumulation of your personally identifiable information (name, contact number, mailing and postal address) concerning your use of our website. This information is stored in an electronic database, which is for HumMart’s website use only. This privacy policy applies to the Site and services provided by HumMart.
...
1.3 You can visit the Website and browse without having to provide personal details. During your visit to the Hummart.com you remain anonymous and at no time can we identify you unless you have an account on the Website and log in with your username and password.
...
1.10 We seek to use information from correspondence which hereby means that you will provide certain essential information if you contact us by email or use any of the webforms on the Website.
...
1.12 It is necessary for the Users to know how we use the collected information; i. To improve our site (the feedback collected from the Users to improve the quality of service provided by HumMart. ii. To send you periodic emails regarding offers and promotions on our Website. iii. To improve communication barrier between User (you) and Service Provider (Us).

1.13 We, at HumMart, ensure that access to customer information is limited to employees or until otherwise necessary. All employees are strictly committed to follow Privacy Policy which in turn implies that we aim to serve you better.
...
1.16 HumMart website links to other social media platforms that may collect personal information, however, HumMart shall not be held responsible for the loss of your data.
...
1.18 To use our Website, you are consenting to our Privacy Policy. We appreciate your trust in us and we promise to protect data. Feel free to contact our customer service team to help you out! Shoot us an email at customer@hummart.com or contact us on (021) 111 116 278.
